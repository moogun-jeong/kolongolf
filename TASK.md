# **TASK.md - 아카이브 다중 사진 표시 강화**

아카이브 카드에서 사진이 한 장인지 여러 장인지 터치 전에도 분명히 보이도록 대표 이미지 위에 사진 수 배지와 갤러리 안내 패널을 추가합니다. 기존 라이트박스 동작과 갤러리 구성은 유지하고 시각적 발견 가능성을 높입니다.

## **1. 현재 진행 중인 작업 (Current Active Task)**
*   [x] 작업 맥락 학습: `AGENTS.md`, `TASK.md`, `PROJECT_LOG.md` 확인
*   [x] 아카이브 대표 이미지 위에 사진 수 배지와 갤러리 안내 패널 추가
*   [x] 모바일에서도 사진 수와 터치 유도가 잘 보이도록 스타일 조정
*   [x] 캐시 버전과 문서 기록 갱신
