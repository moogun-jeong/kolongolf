# **TASK.md - 6월 행사 사진 노출 범위 조정**

2026년 6월 23일 스크린 행사 사진은 해당 행사 기록에만 유지하고, 메인 히어로 사진·풀폭 활동 배너·공유 대표 이미지로 쓰인 사진은 기존 4월 행사 자산으로 복구한 뒤 검증 후 커밋·푸시·배포 확인까지 완료합니다.

## **1. 현재 진행 중인 작업 (Current Active Task)**
*   [x] 작업 맥락 학습: `AGENTS.md`, `TASK.md`, `PROJECT_LOG.md`, `GEMINI.md`, `blueprint.md` 확인
*   [x] 6월 행사 사진이 쓰인 위치 확인: 아카이브, 히어로, 풀폭 활동 배너, OG/preload 이미지
*   [x] 메인 히어로 슬라이드와 히어로 기록 카드를 기존 4월 행사 사진 기준으로 복구
*   [x] 풀폭 활동 배너와 공유 대표 이미지/프리로드 이미지를 기존 4월 행사 자산으로 복구
*   [x] 6월 행사 사진은 2026년 6월 23일 행사 기록의 갤러리에만 남아 있는지 정적 확인
*   [x] `PROJECT_LOG.md`/`blueprint.md` 기록 및 캐시 버전 갱신
*   [x] 문법, 자산, 로컬 서버 응답 검증 및 Chromium headless 이슈 기록
*   [x] 변경 사항 선별 커밋, GitHub `main` 푸시 및 배포 확인
