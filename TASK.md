# **TASK.md - 7/4 아카이브 대표 사진 변경**

2026년 7월 4일 제8회 석노협 스크린골프대회 아카이브의 대표 사진을 `images/archive-2026-07-11.jpeg`로 변경합니다. 기존 갤러리 사진은 유지하고 대표 노출 순서만 조정한 뒤 검증, 커밋, GitHub 푸시까지 완료합니다.

## **1. 현재 진행 중인 작업 (Current Active Task)**
*   [x] 작업 맥락 학습: `AGENTS.md`, `TASK.md`, `PROJECT_LOG.md` 확인
*   [x] 7/4 아카이브 이미지 배열의 첫 번째 사진을 `archive-2026-07-11.jpeg`로 변경
*   [x] 캐시 버전과 문서 기록 갱신
